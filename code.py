import ctypes, json, time, base64, urllib.request, struct, zlib, math, logging
...
SYSTEM_PROMPT = (
    ...
    "Screenshots do not show the mouse cursor. After move_mouse/click_mouse/type_text/scroll_down, tool responses include "
    "cursor position in pixels and normalized 0..1000. "
    # "Workflow: call take_screenshot, then move_mouse to center, then click_mouse, then type_text with exactly 'hello'. "
    # "Then call take_screenshot and verify the word 'hello' is visible. If it is visible, call scroll_down once."
)
# TASK_PROMPT = "Take a screenshot, move mouse to center, click, type hello, take another screenshot and if hello is visible then scroll down once."
...
TOOLS_SCHEMA = [
    {"type": "function", "function": {"name": "take_screenshot", "description": "Capture screen and return current view.", "parameters": {"type": "object", "properties": {}, "required": []}}},
...
def main():
    ...
    for step in range(MAX_STEPS):
        log.info("step=%d request", step + 1)
